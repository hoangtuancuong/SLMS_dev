...
const StudentInfo = ({ userInfo }: { userInfo: UserInfo }) => {
    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 p-8 mt-10">
      ...
      <div className="w-1/3 space-y-6 flex flex-col">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-sm p-6 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400">{'Học sinh'}</p>
        </div>

        {/* Ô Thông tin cá nhân */}
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-sm p-6 ">
          ...
          <div className="font-bold py-3 text-gray-700">
            Thông tin người giám hộ
          </div>
          <div className="border-b py-1 text-gray-700">
            {userInfo?.additional_data || 'Chưa có thông tin'}
          </div>
      ...
      <div className="w-2/3 bg-white dark:bg-gray-800 shadow-lg p-8 ml-8 rounded-sm flex-grow">
